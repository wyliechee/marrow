...
export default function BottomNav() {
  return (
    <nav className="sticky bottom-0 px-2 pb-[env(safe-area-inset-bottom)]" style={{ background: '#fff', borderTop: '1px solid #e9e9e7' }}>
      <div className="flex justify-around max-w-lg mx-auto">
        {tabs.map((tab) => (
          <NavLink
            ...
            className="flex flex-col items-center py-2 px-3 transition-colors no-underline"
            style={({ isActive }) => ({
              color: isActive ? '#5160C8' : '#9b9a97',
            })}
          >
            {tab.icon}
